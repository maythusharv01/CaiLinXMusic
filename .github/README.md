...
- Get your [Necessary Variables](https://github.com/maythusharv01/CaiLinXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/maythusharv01/CaiLinXMusic && cd CaiLinXMusic
   ```
